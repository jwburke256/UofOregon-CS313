...
class T0_tree_left_rotation(unittest.TestCase):
    ...
    def test_tree_left_rotation_3(self):
        ...
        tree.print_tree()
        print("tree after left rotation about intermediate node in preorder")
        print("\n")
...
class T1_tree_right_rotation(unittest.TestCase):
    ...
    def test_tree_right_rotation_3(self):
        ...
        tree_preorder = [node.data for node in tree.preorder()]
        self.assertEqual(tree_preorder, [7,3,1,2,5,6,9,8,10])
        tree.print_tree()
        print("tree after right rotation about intermediate node in preorder")
        print("\n")
...
class T2_tree_insert_color(unittest.TestCase):
    ...
    def test_tree_insert_color_2(self):
        print("\n")
        print("tree_color_check after delete")
        ...
        tree_preorder = [node.data for node in tree.preorder()]
        tree_preorder_color = [node.color for node in tree.preorder()]
        self.assertEqual(tree_preorder, [7, 3, 1, 8, 10])
...
class T3_tree_delete(unittest.TestCase):
    ...
    def test_tree_delete_empty(self):
        print("\n")
        print("tree_insert")
        print("checking delete on empty tree")
        tree = rb_tree()
